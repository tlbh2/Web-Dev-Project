...
app.post("/submit", (req, res) => {
  ...
  res.render("index.ejs", {bandName : name} );
});
...
function randomNameGenerator(){
  let numAdjRandom = Math.floor(Math.random() * adj.length);
  let numNounRandom = Math.floor(Math.random() * noun.length);
  let nameRandom = adj[numAdjRandom] + " " + noun[numNounRandom];
  return nameRandom;
}
